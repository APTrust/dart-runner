...
* Added GetLargeObject to S3 client to allow downloading of objects larger than 5TB.
* Replaced scripts/rub.rb with scripts/run.sh to reduce dependences in dev/test/build.
